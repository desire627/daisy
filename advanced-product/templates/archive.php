...
if ( have_posts()) {
    ...
    <div class="templaza-ap-product-filter uk-margin-bottom uk-flex uk-flex-right uk-hidden@m uk-text-right  uk-position-z-index" data-uk-sticky="start: 20vh; end: !.templaza-content_area; offset: 30vh">
        <span class="ap-filter-btn"><i class="fas fa-sliders-h"></i><?php esc_html_e('Filter','travelami');?></span>
    </div>
        ...
        <div class="uk-flex uk-grid-collapse uk-flex-middle uk-flex-between templaza-ap-archive-view uk-grid" data-uk-grid>
            ...
            if($ap_result){
                ...
                <div class="uk-width-1-3@s uk-flex ap-number-product">
                    <h3 class="uk-margin-remove"><span><?php echo esc_html($post_count);?></span> <?php esc_html_e(' Tours available','travelami');?></h3>
                </div>
                <?php
            }
            ?>
            <div class="uk-width-2-3@s uk-flex uk-flex-middle uk-flex-between uk-flex-right@s">
                ...
                if($ap_sortby){
                    ...
                    <div class="templaza-ap-archive-sort uk-flex uk-flex-middle">
                        <label class="uk-width-auto"><?php echo esc_html__('Sort By', 'travelami')?></label>
                        <div class="uk-form-controls">
                            <select name="ap-archive-sort">
                                <option value="date_high"><?php echo esc_html__('Date: Newest First', 'travelami')?></option>
                                <option value="date_low"><?php echo esc_html__('Date: Oldest First', 'travelami')?></option>
                                <option value="title_low"><?php echo esc_html__('Title: A - Z', 'travelami')?></option>
                                <option value="title_high"><?php echo esc_html__('Title: Z - A', 'travelami')?></option>
                                <option value="price_high"><?php echo esc_html__('Price: High To Low', 'travelami')?></option>
                                <option value="price_low"><?php echo esc_html__('Price: Low To High', 'travelami')?></option>
                            </select>
                        </div>
                    </div>
                    <?php
