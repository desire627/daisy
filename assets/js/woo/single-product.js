(function ($) {
    ...
    templaza_woo.singleProductV4 = function () {
        ...
        // Init zoom for product gallery images
        if ('1' === emberTzData.product_image_zoom) {
            $product.find('.woocommerce-product-gallery .woocommerce-product-gallery__image').each(function () {
                templaza_woo.zoomSingleProductImage(this);
            });
        }
    ...
    templaza_woo.responsiveProductGallery = function () {
        if (typeof emberTzData.product_gallery_slider === 'undefined') {
            return;
        }

        if (emberTzData.product_gallery_slider || !$.fn.wc_product_gallery) {
            return;
        }
        ...
        function initProductGallery() {
            if ($window.width() >= 992) {
                ...
                // Init zoom for product gallery images
                if ('1' === emberTzData.product_image_zoom && $product.hasClass('layout-v3', 'layout-v5')) {
