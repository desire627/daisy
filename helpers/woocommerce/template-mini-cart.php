...
class Templaza_Woo_Mini_Cart {
	...
	public function button_view_cart() {
		echo '<a href="' . esc_url( wc_get_cart_url() ) . '" class="button wc-forward templaza-btn">' . esc_html__( 'View cart', 'travelami' ) . '</a>';
	}
	...
	public function button_proceed_to_checkout() {
		echo '<a href="' . esc_url( wc_get_checkout_url() ) . '" class="button checkout wc-forward templaza-btn templaza-btn-outline">' . esc_html__( 'Checkout', 'travelami' ) . '</a>';
	}
