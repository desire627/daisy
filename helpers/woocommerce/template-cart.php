...
class Templaza_Woo_Cart {
	...
	public function __construct() {
        ...
        $cross_sell      = isset($templaza_options['templaza-shop-cart-cross'])?filter_var($templaza_options['templaza-shop-cart-cross'], FILTER_VALIDATE_BOOLEAN):false;
	...
	public function button_continue_shop() {
		echo sprintf(
			...
			esc_html__( 'Continue Shopping', 'travelami' )
		);
	}
