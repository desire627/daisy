            ...
            <div class="uk-container">
                <div class="uk-flex-center" data-uk-grid data-uk-countdown="date: <?php echo esc_attr($comingsoon_date); ?>">
                    <div>
                        ...
                        <div class="uk-countdown-label uk-margin-small uk-text-center uk-visible@s"><?php echo esc_html__('Days','travelami'); ?></div>
                    </div>
                    <div>
                        <h2 class="uk-countdown-number uk-countdown-hours"></h2>
                        <div class="uk-countdown-label uk-margin-small uk-text-center uk-visible@s"><?php echo esc_html__('Hours','travelami'); ?></div>
                    </div>
                    <div>
                        <h2 class="uk-countdown-number uk-countdown-minutes"></h2>
                        <div class="uk-countdown-label uk-margin-small uk-text-center uk-visible@s"><?php echo esc_html__('Minutes','travelami'); ?></div>
                    </div>
                    <div>
                        <h2 class="uk-countdown-number uk-countdown-seconds"></h2>
                        <div class="uk-countdown-label uk-margin-small uk-text-center uk-visible@s"><?php echo esc_html__('Seconds','travelami'); ?></div>
                    </div>
                </div>
            </div>
