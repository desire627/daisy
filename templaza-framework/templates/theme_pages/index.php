...
$travelami_col_gap      = isset($travelami_options[$prefix.'-column-gap'])?$travelami_options[$prefix.'-column-gap']:'collapse';
...
$show_date          = isset($travelami_options[$prefix.'-date'])?filter_var($travelami_options[$prefix.'-date'], FILTER_VALIDATE_BOOLEAN):true;
$travelami_cl = '';
...
<div id="templaza-archive-<?php echo esc_attr($travelami_id);?>" class="templaza-blog templaza-archive templaza-archive-<?php echo esc_attr(get_post_type().$travelami_custom_class); ?>">
    <div class="templaza-blog-body <?php echo esc_attr($travelami_layout_cl. ' uk-grid-'.$travelami_col_gap);?>" data-uk-grid>
        <?php
        $d=1;
